...
// RETURN THE COMPLETED TASKS IN THE todos TABLE FOR THE CURRENT USER
...
try{
	...
	$query = "SELECT taskId, title, description, createDate, dueDate FROM todos WHERE ownerEmail = '$email' and isDone = 'T' ORDER BY dueDate ASC";
