...
// Send the user's username to the backend and recieve that user's completed task data
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://web.njit.edu/~tat22/IS218/Project2/Back/returnCTasks.php");
...
{
	// Format the completed tasks data and send it back to home.php to be displayed
	...
	foreach($q as $item)
	{
		...
		$output .=  "<div class='t' id='$id'> <b>Title:</b> $title <br> <b>Description:</b> $description <br>".
					...
					"<input type=button id='uncomplete$id' class='completedBtn btn'   value='Mark Incomplete' onClick=\"markAsUncomplete(this.id)\">" .
